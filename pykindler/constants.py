...
CONST['temp_metadata_file'] =  path.join(CONST['downloads_dir'],"temp_metadata_storage.opf")
CONST['processed_dir'] = path.join(CONST['downloads_dir'],'Processed_Books')
CONST['convered_dir'] = path.join(CONST['downloads_dir'],'Converted_Books')